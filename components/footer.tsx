  ...
  return (
    <footer className="bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <StaggerContainer className="grid md:grid-cols-5 gap-8 mb-12">
          <StaggerItem>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-300">True health belongs to everyone.</div>
                </div>
              </div>
          ...
          <StaggerItem>
            <div>
            <h3 className="font-semibold mb-4">お問い合わせ先</h3>
            <div className="space-y-3 text-sm text-gray-300">
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4" />
                <span>info@msgcorp.jp</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <div>〒150-0002</div>
                  <div>東京都渋谷区渋谷3-6-2</div>
                  <div>YAGI bldg.2 3F</div>
                </div>
              </div>
            </div>
            </div>
        ...
        <FadeInWhenVisible>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-300">&copy; 2024 MSG株式会社. All rights reserved.</div>
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-4 text-gray-300">
                <a href="#" className="hover:text-white transition-colors" aria-label="MSG株式会社のTwitterアカウント">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="#" className="hover:text-white transition-colors" aria-label="MSG株式会社のLinkedInアカウント">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
